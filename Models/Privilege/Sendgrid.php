...
class Sendgrid
{
	...
	public static function expPurchase_tpl($options){
...
<html data-editor-version="2" class="sg-campaigns" xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns">
      ...
      <table style="padding: 0px 0px 0px 0px;" align="left" valign="top" height="100%" class="column column-0 of-2 empty"> <tr>
    ...
    <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
      <tr>
        ...
        <span style="font-size:20px;">Congratulations,</span></span></div>
        </td>
      </tr>
    </table>
    <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
...
<table border="0" cellpadding="0" cellspacing="0" style="width:500px;">
	<tbody>
      ...
      <td>'.$options['total_tickets'].'</td>
		</tr>
		<tr>
			<td>Transaction id</td>
      <td>'.$options['txn_id'].'</td>
		</tr>
	</tbody>
</table>
</div>
<div>&nbsp;</div><div>&nbsp;</div>
<div>
Thank you for booking with Food Talk Privilege, Now you can book experiences, get great deals & discount and much more using food talk app. 
Now available on <a href="https://play.google.com/store/apps/details?id=in.foodtalk.privilege">Play Store</a> and <a href="https://itunes.apple.com/in/app/food-talk-privilege/id1246265932" >App Store</a>.
<br><br>
If you have any problems/concerns about your booking, you can write to us at <strong>contact@foodtalkindia.com </strong>
<br><br>
Team Food Talk
</div>
</div></td> </tr> </table> </td> </tr> </table></td> </tr> </table> </td> </tr> </table> </td> </tr> </table> </div> </center> </body> </html>'; 
	}
